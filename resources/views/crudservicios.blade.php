        ...
        <div class="row justify-content-center">
            <div class="col-md">
                    ...
                    <div class="card-body">
                        <form id="form1" name="form2" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="problemas"
                                           class="form-control @error('problema_reportado') is-invalid @enderror"
                                           value="{{old('problema_reportado')}}" name="problema_reportado" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input readonly="readonly" id="equipo_id"
                                           class="form-control @error('id_del_equipo') is-invalid @enderror"
                                           value="{{old('id_del_equipo')}}" name="id del equipo" required autocomplete>
                                    @error('id_del_equipo')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div align="center">
                    ...
                    <div class="btn-group col-md">
                        <input id="descargar" disabled="true" type="button" value="Descargar" class="btn btn-info"
                               onclick="imprimirOrdenDeServicio()"/>
                    </div>
                    <script type="text/javascript">
